    ...
    modules: [
      ...
      },
      {
        ...
        lesson: {
          title: 'Пошагово по всем периодам родов',
          content:
            'Роды делятся на три периода, и в каждом происходит что-то своё. Разберём их по порядку, чтобы вы понимали, что и когда ожидать.\n\nПервый период — раскрытие шейки матки. Он делится на две фазы. Латентная фаза: схватки нерегулярные, по 30–45 секунд, с большими промежутками, шейка раскрывается медленно, до 4–5 см — обычно эта фаза проходит дома. Активная фаза: схватки учащаются и усиливаются, промежутки сокращаются до 3–5 минут, шейка раскрывается быстрее, вплоть до полного раскрытия в 10 см. Именно в активной фазе обычно едут в роддом, если ещё не приехали, и чаще выбирают обезболивание.\n\nВ течение первого периода врач может вскрыть плодный пузырь (амниотомия), если это необходимо, назначить окситоцин для усиления родовой деятельности и вести контроль сердцебиения малыша (КТГ). Это стандартные элементы ведения родов, а не признак того, что что-то идёт не так.\n\nВторой период — потуги и рождение малыша. Начинается с полного раскрытия шейки матки и заканчивается рождением ребёнка. Обычно длится от 20 минут до 2 часов у первородящих и быстрее у повторнородящих. Тужиться начинают только по команде врача или акушерки — раннее натуживание может привести к отёку и разрывам. В этот период возможна эпизиотомия (рассечение промежности) при угрозе разрыва или по показаниям со стороны малыша.\n\nТретий период — рождение последа. Самый короткий: обычно 5–30 минут после рождения ребёнка. Матка сокращается, отделяет и выталкивает плаценту. Врач осматривает плаценту и оболочки, чтобы убедиться, что в матке ничего не осталось — это важно для профилактики кровотечения.\n\nСразу после родов начинается ранний послеродовой период — первые часы наблюдения за мамой (сокращение матки, кровопотеря) и первый контакт с малышом, если позволяет состояние обоих.',
        },
      },
    ],
  },
